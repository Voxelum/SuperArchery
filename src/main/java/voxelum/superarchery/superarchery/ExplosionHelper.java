...
public class ExplosionHelper {
     ...
     * finished)
     * <p>
     * You can customize the damage source from this method.
     */
    public static net.minecraft.world.Explosion newExplosion(EntityExplosionArrow entityIn, double x, double y, double z, float strength,
                                                             boolean causesFire, boolean damagesTerrain, DamageSource source) {
        World world = entityIn.world;
        final Entity exploder = entityIn;
        float size = strength;
        net.minecraft.world.Explosion explosion = new net.minecraft.world.Explosion(entityIn.world, entityIn, x, y, z, strength, causesFire, damagesTerrain) {
            @Override
            public void doExplosionA() {
                        ...
                        for (int l = 0; l < 16; ++l) {
                            if (j == 0 || j == 15 || k == 0 || k == 15 || l == 0 || l == 15) {
                                ...
                                for (float f1 = 0.3F; f > 0.0F; f -= 0.22500001F) {
                                    ...
                                    if (f > 0.0F && (exploder == null || exploder.canExplosionDestroyBlock(this, world,
                ...
                List<Entity> list = world.getEntitiesWithinAABBExcludingEntity(exploder, new AxisAlignedBB((double) k1,
                            ...
                            if (d13 != 0.0D) {
                                ...
                                if (entity instanceof EntityPlayer) {
                                    ...
                                    if (!entityplayer.isSpectator()
                                        ...
                                        getPlayerKnockbackMap().put(entityplayer,
                                                new Vec3d(d5 * d10, d7 * d10, d9 * d10));
                                    }
                                }
                            }
                        }
