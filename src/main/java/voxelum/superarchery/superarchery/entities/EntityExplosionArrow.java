...
public class EntityExplosionArrow extends EntityTippedArrow {
     ...
     * finished)
     */
    public static Explosion newExplosion(EntityExplosionArrow entityIn, double x, double y, double z, float strength,
                    ...
                    if (!entity.isImmuneToExplosions()) {
                        ...
                        if (d12 <= 1.0D) {
                            ...
                            if (d13 != 0.0D) {
                                ...
                                entity.attackEntityFrom(entityIn.getDamangeSource(),
